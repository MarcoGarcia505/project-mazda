...
<head>
    ...
    <link rel="shortcut icon" href="{{ url('images/icons/logo_cwa.svg') }}" title="Favicon"/>
...
<body>
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light animate__animated animate__fadeInDown {{ !request()->is('/') ? 'scrolled awake' : '' }}" id="ftco-navbar">
    <div class="container">
        <!--Logo that is shown on the banner-->
        <img src="<?= url('images/icons/logo_cwa.png') ?>" class="banner-logo" alt="Landing Page">
        <!--End of Banner Logo-->
